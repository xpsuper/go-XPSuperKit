...
// params 任务执行函数所需要的参数
func (a *XPAsyncImpl) Add(name string, handler interface{}, params ...interface{}) bool {
...
func (a *XPAsyncImpl) Run() (chan map[string][]interface{}, bool) {
	if a.count < 1 {
		return nil, false
	}
